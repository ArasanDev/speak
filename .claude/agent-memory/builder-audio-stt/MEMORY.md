...
- [SpeechAnalyzer vocabulary API](speechanalyzer-vocabulary.md) — custom vocab goes through AnalysisContext.contextualStrings[.general] + setContext, NOT SpeechTranscriber init
