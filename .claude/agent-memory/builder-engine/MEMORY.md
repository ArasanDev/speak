...
- [Voice Actions H-1](project-voice-actions-h1-skeleton.md) — router design + how it was wired live (loop #45): CaptureSession.stop seam, prefix-gated catalog fetch, action route live / command route deferred
