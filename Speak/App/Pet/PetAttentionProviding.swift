...
// a real conformer later without touching Voice Desktop Pet's code.

import Foundation

/// Supplies the count Voice Desktop Pet's `.attention` state and badge are driven by.
...
/// AVB-7 lands; Voice Desktop Pet never regresses because `.attention` simply never fires.
